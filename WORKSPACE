...
tensorflow_http_archive(
    ...
    patch_cmds = [
        ...
        "sed -i '/name = \"cuda\",/,/deps = \\[/ s#deps = \\[#deps = [\"//xla/tsl/platform:dso_loader\", \"//xla/tsl/platform:logging\", #' third_party/xla/xla/tsl/cuda/BUILD.bazel",
        "sed -i '/name = \"nvshmem\",/,/deps = \\[/ s#deps = \\[#deps = [\"//xla/tsl/platform:dso_loader\", #' third_party/xla/xla/tsl/cuda/BUILD.bazel",
        "sed -i '/name = \"cudart_stub\",/,/deps = \\[/ s#deps = \\[#deps = [\"//xla/tsl/platform:dso_loader\", #' third_party/xla/xla/tsl/cuda/BUILD.bazel",
