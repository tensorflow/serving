...
tensorflow_http_archive(
    ...
    patch_cmds = [
        ...
        "python3 -c 'import os; os.makedirs(\"tensorflow\", exist_ok=True); open(\"tensorflow/BUILD\", \"a\").write(\"\\nconfig_setting(name = \\\"with_tpu_support\\\", define_values = {\\\"with_tpu_support\\\": \\\"true\\\"}, visibility = [\\\"//visibility:public\\\"])\\n\")'",
