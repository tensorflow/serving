...
#ifndef TENSORFLOW_SERVING_UTIL_CLEANUP_H_
#define TENSORFLOW_SERVING_UTIL_CLEANUP_H_
...
Cleanup<DecayF> MakeCleanup(F&& f) TF_MUST_USE_RESULT;
...
#endif  // TENSORFLOW_SERVING_UTIL_CLEANUP_H_
