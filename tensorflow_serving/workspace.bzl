...
def tf_serving_workspace():
    ...
    http_archive(
        ...
        sha256 = "ec01fdc7c62b0854e25c6a5109599efef85472a2bfcabd4cdd9e53cb3e61c967",
        strip_prefix = "text-2.10.0",
        url = "https://github.com/tensorflow/text/archive/v2.10.0.zip",
