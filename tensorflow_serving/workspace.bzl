...
def tf_serving_workspace():
    ...
    http_archive(
        ...
        strip_prefix = "text-2.21.0",
        urls = [
            "https://storage.googleapis.com/mirror.tensorflow.org/github.com/tensorflow/text/archive/v2.21.0.zip",
            "https://github.com/tensorflow/text/archive/v2.21.0.zip",
        ],
        repo_mapping = {
