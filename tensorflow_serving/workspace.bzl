...
def tf_serving_workspace():
    ...
    http_archive(
        ...
        sha256 = "78e2289ae780424aee8590367e2bd1e4ed1da181869331e90664e0dc6021db4c",
        strip_prefix = "text-2.12.0",
        url = "https://github.com/tensorflow/text/archive/v2.12.0.zip",
