...
_MNISTREQUEST.fields_by_name['image_data']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), b'\020\001')
_MNISTRESPONSE.fields_by_name['value'].has_options = True
_MNISTRESPONSE.fields_by_name['value']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), b'\020\001')
import abc
...
class EarlyAdopterMnistServiceServicer(object):
  """<fill me in later!>"""
  __metaclass__ = abc.ABCMeta
  @abc.abstractmethod
  def Classify(self, request, context):
    raise NotImplementedError()
class EarlyAdopterMnistServiceServer(object):
  """<fill me in later!>"""
  __metaclass__ = abc.ABCMeta
  @abc.abstractmethod
  def start(self):
  ...
  def stop(self):
    raise NotImplementedError()
class EarlyAdopterMnistServiceStub(object):
  """<fill me in later!>"""
  __metaclass__ = abc.ABCMeta
  @abc.abstractmethod
