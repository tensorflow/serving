...
#ifndef TENSORFLOW_SERVING_MODEL_SERVERS_TFRT_PREDICTION_SERVICE_IMPL_H_
#define TENSORFLOW_SERVING_MODEL_SERVERS_TFRT_PREDICTION_SERVICE_IMPL_H_
...
class TfrtPredictionServiceImpl final
 ...
 private:
  absl::Time GetRequestDeadline(::grpc::ServerContext* context) const;
...
#endif  // TENSORFLOW_SERVING_MODEL_SERVERS_TFRT_PREDICTION_SERVICE_IMPL_H_
