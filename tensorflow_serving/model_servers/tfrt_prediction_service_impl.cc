...
#include "tensorflow_serving/apis/inference.proto.h"
...
::grpc::Status TfrtPredictionServiceImpl::Predict(
  ...
  auto tf_status = servable->Predict(run_options, *request, response);
...
::grpc::Status TfrtPredictionServiceImpl::Classify(
  ...
  TF_RETURN_IF_ERROR(
      core_->GetServableHandle(request->model_spec(), &servable));
  auto tf_status = servable->Classify(run_options, *request, response);
...
::grpc::Status TfrtPredictionServiceImpl::Regress(
  ...
  TF_RETURN_IF_ERROR(
      core_->GetServableHandle(request->model_spec(), &servable));
  auto tf_status = servable->Regress(run_options, *request, response);
...
::grpc::Status TfrtPredictionServiceImpl::MultiInference(
  ...
  auto tf_status = servable->MultiInference(run_options, *request, response);
