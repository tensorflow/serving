...
class TFRTHttpRestApiHandlerTest : public ::testing::Test {
 ...
 protected:
  ...
  static absl::Status CreateServerCore(
    ...
    *saved_model_bundle_source_adapter_config.mutable_saved_model_config()
         ->mutable_legacy_config() = SessionBundleConfig();
...
TEST_F(TFRTHttpRestApiHandlerTest, GetModelMetadata) {
  HeaderList headers;
  string model_name, method, output;
