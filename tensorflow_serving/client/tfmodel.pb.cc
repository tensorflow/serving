...
namespace protobuf_tfmodel_2eproto {
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "tfmodel.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] = {
      "\n\rtfmodel.proto\022\022tensorflow.serving\032\036goo"
      "gle/protobuf/wrappers.proto\"_\n\tModelSpec"
      "\022\014\n\004name\030\001 \001(\t\022,\n\007version\030\002 \001(\0132\033.google"
      ".protobuf.Int64Value\022\026\n\016signature_name\030\003"
      " \001(\tB\003\370\001\001b\006proto3"
  };
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
      descriptor, 177);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "tfmodel.proto", &protobuf_RegisterTypes);
...
ModelSpec::ModelSpec()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_tfmodel_2eproto::InitDefaults();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* ModelSpec::descriptor() {
  protobuf_tfmodel_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_tfmodel_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::protobuf::Metadata ModelSpec::GetMetadata() const {
  protobuf_tfmodel_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_tfmodel_2eproto::file_level_metadata[kIndexInFileMessages];
}
